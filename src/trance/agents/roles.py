...
BUILTIN_ROLES: dict[str, AgentRole] = {
    ...
    "visual-tester": AgentRole(
        ...
        system_prompt=(
            ...
            "nothing changed, look before concluding the key did nothing. A key is "
            "held for a few frames so a game that checks the keyboard every frame "
            "notices it; to move something a long way, press it with a larger `hold` "
            "rather than pressing it many times.\n"
