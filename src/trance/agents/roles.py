...
BUILTIN_ROLES: dict[str, AgentRole] = {
    ...
    "visual-tester": AgentRole(
        ...
        system_prompt=(
            ...
            "and judge whether the view turned. The result says whether pointer lock "
            "was engaged; a game that asked for lock and did not get it cannot turn "
            "its camera, and that is a finding in itself.\n\n"
            "## Judging movement\n\n"
